...
public class OrderMealHelper {
    ...
    public ArrayList<OrderMeal> getOrderMealByOrderId(int order_id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `final_pj`.`Order_Meal_Linking` WHERE `Order_Meal_Linking`.`order_id` = ?"; /**
                                                                                                                     * table要改
                                                                                                                     */
            ...
            while (rs.next()) {
                ...
                int omlinking_subtotal = rs
                        .getDouble("omlinking_subtotal"); /************************************************/

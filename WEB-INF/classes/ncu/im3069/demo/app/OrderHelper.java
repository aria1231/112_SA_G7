...
public class OrderHelper {
    ...
    private static OrderHelper ordh;
    ...
    public JSONObject create(Order order) {							
        ...
        String exexcute_sql = "";
        long id = -1;
        JSONArray oma = new JSONArray();
        
        try {
            /** 取得資料庫之連線 */
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `final_pj`.`Order`(`member_id`, `movie_id`, `room_id`, `order_date`, `order_total_price`, `order_time_of_day`, `order_datetime`, `order_status`)"
                    + " VALUES(?, ?, ?, ?, ?, ?, ?, ?)";  																
            ...
            if (rs.next()) {
                id = rs.getLong(1);
                ArrayList<OrderMeal> omd = order.getOrderMealList();
                oma = omh.createByList(id, omd);
            }
        ...
        response.put("order_meal_id", oma);							
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `final_pj`.`Order`";
    ...
    public JSONObject getById(String order_id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `final_pj`.`Order` WHERE `Order`.`order_id` = ?";
	...
	public JSONObject getByMemberId(String member_id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `final_pj`.`Order` WHERE `Order`.`member_id` = ?";  			/**table要改*/
	...
	public JSONObject deleteOrderByOrderId(int order_id){
		/** 記錄實際執行之SQL指令 */
        String exexcute_sql = "";
        /** 紀錄程式開始執行時間 */
        long start_time = System.nanoTime();
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `final_pj`.`Order` WHERE `Order_id` = ? LIMIT 1";
